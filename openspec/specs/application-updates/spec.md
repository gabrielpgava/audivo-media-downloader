...
Audivo checks official stable releases periodically and presents user-controlled update information without silently updating or interrupting downloads.
